...
// file, rather than the first prefix that matches; and if visual separators are
// correctly ignored in matching
TEST_F(JSONEnumServiceTest, PrefixMatching)
{
  ...
  // Matches to the most specific four-digits-prefix (with visual separators), 
  // rather than any rule before or after it
